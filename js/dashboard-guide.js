...
var DashboardGuide = (function () {
    ...
    var GUIDES = {
        ...
        'dash-chart': {
            view: 'view-dashboard', menu: '통합 대시보드', title: '실시간 채널별 시간 매출',
            summary: '조회시각 기준 최근 24시간의 채널별 매출을 정각 기준 1시간 단위로 합산해 보여줍니다.',
            keywords: ['차트', '실시간', '24시간', '시간별', '채널', '매출', '그래프'],
            faq: [
                { q: '조회 기간은?', a: '현재 시각의 정각부터 24시간 전 정각까지 총 25개 시간대를 표시하며, 현재 시간은 조회 분까지의 실적입니다.' },
                { q: '막대는 무엇을 뜻하나요?', a: '색상별 영역은 해당 1시간에 발생한 채널별 매출 합계이고, 막대 전체 높이는 그 시간의 통합 매출입니다. 노란 선은 시간대별 전 채널 합계 주문건수입니다.' },
                { q: '추가 지표는?', a: '당일 매출·당일 주문(0시 이후 누적)·최고 매출 시간대·수집 지연을 차트 위에서 확인하며, 당일 매출·주문 카드를 클릭하면 채널별 상세가 팝업으로 열립니다.' }
            ]
        },
        ...
        'dash-promo': {
            ...
            faq: [
                { q: '레이아웃은?', a: '왼쪽: 진행/기획/완료 건수, 진행중 프로모션별 D-day·목표 달성률, 전체 목표 대비 매출. 오른쪽: 해당 월 스케줄 축소판.' },
                { q: '스케줄 날짜를 클릭하면?', a: '해당 일자에 걸친 프로모션의 기간·채널·목표 대비 실적이 팝업으로 열립니다.' },
                { q: '왜 CRM으로 바로 안 가나요?', a: '홈에서는 현황만 요약합니다. 「상세」는 팝업, 신규 등록·편집은 좌측 「프로모션 기획 · 성과」 메뉴에서 합니다.' },
        ...
        'dash-order-feed': {
            ...
            summary: '상단에 최근 24시간 베스트 5 상품(매출액/주문건수 탭), 아래에 최근 주문 5건을 표시합니다.',
            keywords: ['주문', '피드', '실시간', '최근', '테이블', '베스트', '상품'],
            faq: [
                { q: '베스트 5 상품은 무엇 기준인가요?', a: '최근 24시간 수집 주문을 상품별로 집계해 매출액 또는 주문건수 기준 상위 5개를 탭으로 전환하며 보여줍니다.' },
